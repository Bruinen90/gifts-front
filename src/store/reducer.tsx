...
const reducer = (
	...
	switch (action.type) {
		...
		case actionTypes.SET_WISH_STATUS:
			let updatedDrawsArr: DrawInterface[];
			let updatedOtherUsersWishes: OtherUsersWishes;
			let addedGift: Wish;
			{
				...
				if (drawId) {
					...
					updatedDrawsArr = state.usersDraws;
				}
			}
			return {
				...state,
				usersDraws: updatedDrawsArr,
