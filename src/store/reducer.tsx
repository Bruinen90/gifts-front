...
const reducer = (
  ...
  switch (action.type) {
      ...
      return {
        ...
        usersDraws: [...state.usersDraws!].map((draw) => {
          ...
          if (!draw.results.gifts && action.payload.reserved) {
            ...
            updatedGiftsForFoundDraw = [...draw.results.gifts!, addedGift];
          }
          // Update state
          return {
            ...draw,
              ...
              getterWishes: draw.results.getterWishes
                ? [...draw.results.getterWishes].map((wish) => {
                    ...
                    return {
                      ...
                      buyer: action.payload.reserved ? state.userId : undefined,
                    };
                  })
                : [],
            },
    ...
    case actionTypes.SET_USER_INVITATIONS:
      ...
      return {
        ...state,
        invitations: { received: receivedInvitations, sent: sentInvitations },
      };
