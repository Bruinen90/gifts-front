...
import { InvitationFromDB } from "../interfaces/Friends";
...
const reducer = (
    ...
    switch (action.type) {
        ...
        case actionTypes.SET_USER_INVITATIONS:
            const responseInvitations = action.payload.responseInvitations as {
                received: InvitationFromDB[];
                sent: InvitationFromDB[];
            };
            responseInvitations.received = responseInvitations.received.map(
                (invitation) => ({
                    ...invitation,
                    receiver: {
                        _id: state.userId,
            ...
            responseInvitations.sent = responseInvitations.sent.map(
                (invitation) => ({
                    ...invitation,
                    sender: {
                        _id: state.userId,
